...
def segParagraph(rawtext: str):
    """To be paired with sentence-level seg method. Returns a list of fully segmentated paragraph until word-level. Basically divParagraph: list => [segSentence] => wash"""
